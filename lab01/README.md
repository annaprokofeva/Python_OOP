...
Для отчисленных — нельзя менять курс и оценку
...
Возраст (_age)
Курс (_course)
Оценка и статус на равенство не влияют.
...
Состояние	Значение	Что можно делать
Активен	True	Можно менять курс, оценку, переводиться
Отчислен	False	Нельзя ничего менять
